        ...
        <>
            <header className='h-20 w-full bg-white shadow-md'>
                <nav className='container mx-auto h-full flex justify-between items-center'>
                    ...
                    <div className='flex items-center gap-6 uppercase font-semibold h-full'>
                        <a href="#">Product</a>
                        <a href="#">About</a>
                        <a href="#">Contact</a>
                        <a href="#">Log In</a>
                        <div className=' relative'>
                            ...
                            <small className='text-purple-500 text-lg px-1 rounded-full absolute bottom-0 right-[5px] cursor-pointer '>00</small>
                        </div>
                    </div>
                </nav>
            </header>
